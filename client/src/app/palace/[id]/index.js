...
// REMOVED: const { width: SCREEN_WIDTH... } = Dimensions.get('window');
// We will use the hook inside the component instead.
            ...
            Gesture.Pan()
                ...
                .onUpdate(e => {
                    ...
                    translateX.value = clampValues(
                        ...
                        scale.value,
                        mapData.pixelWidth,
                        screenWidth // Fixed: Uses dynamic width
                    );
                    translateY.value = clampValues(
                        rawY,
                        scale.value,
                        mapData.pixelHeight,
                        screenHeight // Fixed: Uses dynamic height
                    );
                })
                .onEnd(() => {
                    savedTranslateX.value = translateX.value;
